...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root_action, 1, 0, 1),
  ...
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root_action, 2, 0, 3),
  ...
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root_action, 2, 0, 2),
  ...
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root_action, 3, 0, 4),
